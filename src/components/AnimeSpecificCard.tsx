  ...
  (
    ...
    return (
      <div className="relative w-full max-w-sm">
        {/* Naruto Character Overlay - Positioned absolutely to extend beyond card */}
        <div className="absolute -top-24 -left-20 z-20 w-80 h-80 sm:w-96 sm:h-96 md:w-[26rem] md:h-[26rem] pointer-events-none">
          <img
